...
| Cover | Dashboard |
|-----------|----------|
| ![](assets/cover.png) | ![](assets/dashboard.png) |

| Products | Orders |
|--------|-----------|
| ![](assets/products.png) | ![](assets/orders.png) |

| Analytics | Settings |
|-----------|----------|
| ![](assets/onbording.png) | ![](assets/settings.png) |

|  profile | Mobile | 
|--------|-----------|
| ![](assets/profile.png) | ![](assets/mobile.png) |
